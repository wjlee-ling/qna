...
class KiwiTokenizer(BM25Tokenizer):
    def __init__(self, stopwords: List[str] = None, user_dict_path: str = None):
...
class BM25Encoder(BaseSparseEncoder):
    ...
    def replace_with_Kiwi_tokenizer(self, kiwi: KiwiTokenizer):
        self._tokenizer = kiwi
